...
**环境配置**:
- Dev: 49.233.219.254:9200 (develop 分支)
- QA: 49.233.219.254:9201 (release 分支)
- Prod: 129.28.125.51:9202 (main 分支)
...
| 任务 | 状态 | 备注 |
|------|------|------|
| Dev 容器运行验证 | ✅ | http://49.233.219.254:9200 |
| QA 容器运行验证 | ✅ | http://49.233.219.254:9201 |
| 腾讯云防火墙配置 | ✅ | 开放 9200/9201/9202 端口 |
...
| 环境 | 地址 | 状态 |
|------|------|------|
| 开发 | http://49.233.219.254:9200 | ✅ 正常 |
| 测试 | http://49.233.219.254:9201 | ✅ 正常 |
| 生产 | https://youshu.asia | ✅ 正常 |
