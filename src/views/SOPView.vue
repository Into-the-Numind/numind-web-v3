<template>
    ...
    <div class="top-bar">
      <div class="top-bar-left">
        <a
          ...
          class="top-bar-back"
          onclick="handleBackToHome(event)"
          title="返回首页"
        >
          <svg
            width="18"
        ...
        <div class="content-wrapper">
          ...
          <div class="step-content active" id="step-1">
            <div class="step-content-header">
              <div class="step-content-title">第 1 步：AI 拆解产品</div>
              <div class="step-content-description">请将你的产品介绍输入或上传到下方</div>
            </div>
            ...
            <div class="page-tip" style="margin-bottom: 24px">
              ...
              一、核心业务定位
              (1)您是做什么的？(2)核心差异化是什么？(3)核心客户是谁？(4)帮客户解决了什么核心痛点？<br />
            ...
            <div class="input-section">
              ...
              <textarea
                ...
                id="product-input"
                placeholder='请输入产品介绍内容，或点击"上传文件"'
              ></textarea>
            </div>
            ...
            <div class="nav-buttons">
              <div></div>
              <button class="btn btn-primary" id="step1-next-btn" onclick="handleStep1Next()">
                下一步
              </button>
            </div>
          </div>
          ...
          <div class="step-content" id="step-2">
            <div class="step-content-header">
              <div class="step-content-title">第 2 步：AI拆解IP语言风格</div>
              <div class="step-content-description">在下方输入或上传你的历史朋友圈文稿</div>
            </div>
            ...
            <div class="input-section">
              ...
              <textarea
                class="input-textarea"
                id="script-input"
                placeholder='请输入你的历史朋友圈文稿，或点击"上传文件"'
              ></textarea>
            </div>
            ...
            <div class="nav-buttons">
              ...
              <button class="btn btn-primary" id="step2-next-btn" onclick="handleStep2Next()">
                下一步
              </button>
            </div>
          </div>
          ...
          <div class="step-content" id="step-3">
            <div class="step-content-header">
              <div class="step-content-title">第 3 步：AI 拆解爆款朋友圈文案</div>
              <div class="step-content-description">在下方输入或上传爆款朋友圈文案</div>
            </div>
            ...
            <div class="input-section">
              ...
              <textarea
                class="input-textarea"
                id="style-input"
                placeholder='请输入爆款朋友圈文案内容，或点击"上传文件"'
              ></textarea>
            </div>
            ...
            <div class="nav-buttons">
              <button class="btn btn-secondary" onclick="prevStep()">&#x2190; 上一步</button>
              <button class="btn btn-primary" id="step3-next-btn" onclick="handleStep3Next()">
                下一步
              </button>
            </div>
          </div>
          ...
          <div class="step-content" id="step-4">
            <div class="step-content-header">
              <div class="step-content-title">第 4 步：AI 进行创作</div>
              <div class="step-content-description">在下方输入创作主题</div>
            </div>
            ...
            <div class="nav-buttons">
              <button class="btn btn-secondary" id="step4-prev-btn" onclick="handleStep4Prev()">
                &#x2190; 上一步
              </button>
              <button class="btn btn-primary" id="step4-next-btn" onclick="handleStep4Next()">
                生成仿写文稿
              </button>
            </div>
          </div>
  ...
  <div
    ...
    style="display: none"
    onclick="closeHistoryModalOnOverlay(event)"
  >
