...
const allTabs: ConfigTab[] = [
  { label: 'AI 工作流', path: '/config/sop-templates', group: 'tools' },
  { label: 'AI 问答助手', path: '/config/chatbots', group: 'tools' },
  { label: 'AI 智能体', path: '/config/agents', group: 'tools' },
  { label: '知识库', path: '/config/knowledge-bases', group: 'assets' },
  { label: 'Skill', path: '/config/skills', group: 'assets' }
]

const tabGroups = computed(() => [
  { label: '首页工具', tabs: allTabs.filter((t) => t.group === 'tools') },
  { label: '能力资产', tabs: allTabs.filter((t) => t.group === 'assets') }
])
