          ...
          <div v-if="showPurchaseModal" class="modal-overlay" @click.self="closePurchaseModal">
            <div class="modal-dialog tier-dialog">
              ...
              <div class="modal-body">
                ...
                <div class="purchase-pay-channel">
                  ...
                  <div class="pay-channel-options">
                    ...
                    >
                      <div class="upgrade-radio" :class="{ active: purchaseForm.payChannel === 'wechat' }"></div>
                      <span>微信支付</span>
                    </div>
                    <div
                      class="pay-channel-card"
                    ...
                    >
                      <div class="upgrade-radio" :class="{ active: purchaseForm.payChannel === 'alipay' }"></div>
                      <span>支付宝</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn-primary" :disabled="purchaseLoading" @click="handlePurchase">
              ...
              <div class="modal-body" style="text-align: center; padding: 24px;">
                <template v-if="purchaseOrder">
                  ...
                  <template v-else>
                    ...
                    <a :href="purchaseOrder.code_url" target="_blank" style="color: var(--accent); text-decoration: underline;">点击此处重新打开支付页面</a>
                  </template>
                  <p style="margin-top: 16px; color: #999; font-size: 0.85em;">支付完成后将自动确认，请勿关闭此窗口</p>
                </template>
              </div>
            </div>
          </div>
...
const purchaseAmount = computed(() => {
  switch (purchaseForm.productType) {
    case 'trial': return 9.9
    case 'monthly': return 99 * purchaseForm.months
    case 'yearly': return 949
    case 'booster': return 29.9
    default: return 0
  }
})
...
.purchase-pay-channel { margin-top: 16px; }
...
.pay-channel-card:hover { border-color: hsl(155, 20%, 80%); }
.pay-channel-card.selected { border-color: hsl(158, 64%, 50%); background: hsl(158, 50%, 97%); }
</style>
